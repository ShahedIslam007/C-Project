...
namespace MyProject
{
    public partial class AdminControlerEight : UserControl
    {
        string cs = ConfigurationManager.ConnectionStrings["dbcs"].ConnectionString;
        public AdminControlerEight()
        {
            InitializeComponent();
            GridView();
        }
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "insert into Nearby_Maqtab values(@Name,@District,@Area)";
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "update Nearby_Maqtab set Name=@Name, District=@District, Area=@Area where Name=@Name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@Name", textBox2.Text);
            cmd.Parameters.AddWithValue("@District", comboBox2.Text);
            cmd.Parameters.AddWithValue("@Area", textBox1.Text);
        ...
        {
            SqlConnection con = new SqlConnection(cs);
            string query = "delete from Nearby_Maqtab where Name=@Name";
            SqlCommand cmd = new SqlCommand(query, con);
            cmd.Parameters.AddWithValue("@Name", textBox2.Text);
